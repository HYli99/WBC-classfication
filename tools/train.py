...
print("Registered Heads:", HEADS.module_dict.keys())  # 应包含'CustomLinearClsHead'
#D:\\StudyCode\\LearnPractice_ML\\mmclassification\\configs\\resnet\\resnet18_8xb32_in1k.py
